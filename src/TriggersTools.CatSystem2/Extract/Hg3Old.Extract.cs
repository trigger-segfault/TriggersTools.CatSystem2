...
namespace TriggersTools.CatSystem2 {
	partial class Hg3Old {
		...
		/// <returns>The extracted <see cref="Hg3Old"/> information.</returns>
		/// 
		/// <exception cref="ArgumentNullException">
		///  <paramref name="hg3File"/> or <paramref name="directory"/> is null.
		/// </exception>
		public static Hg3Old ExtractImages(string hg3File, string directory, bool expand) {
		...
		/// </exception>
		public static Hg3Old ExtractImages(Stream stream, string fileName, string directory, bool expand) {
		...
		/// <returns>The <see cref="Hg3Old"/> file information.</returns>
		/// 
		/// <exception cref="ArgumentNullException">
		///  <paramref name="hg3File"/> is null.
		/// </exception>
		public static Hg3Old Extract(string hg3File) {
			using (var stream = File.OpenRead(hg3File))
		...
		///  The <paramref name="stream"/> is closed.
		/// </exception>
		public static Hg3Old Extract(Stream stream, string fileName) {
