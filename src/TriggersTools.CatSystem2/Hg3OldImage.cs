...
namespace TriggersTools.CatSystem2 {
	...
	/// </summary>
	public sealed class Hg3OldImage {
		#region Fields
		...
		/// </summary>
		[JsonIgnore]
		public Hg3Old Hg3 { get; internal set; }
		/// <summary>
		...
		/// </summary>
		[JsonIgnore]
		public int CenterRight => TotalWidth - BaseX;
		/// <summary>
		...
		/// </summary>
		[JsonIgnore]
		public int BaselineBottom => TotalHeight - BaseY;
		...
		public Hg3OldImage() { }
		/// <summary>
		///  Constructs an HG-3 image with the specified file name, image index, <see cref="Hg3Old.HG3STDINFO"/>, and
		///  bitmap frames.
		/// </summary>
		...
		internal Hg3OldImage(int imageIndex, HG3STDINFO stdInfo, long[] frameOffsets, Hg3Old hg3) {
			Hg3 = hg3;
			...
			HasTransparency = stdInfo.IsTransparent;
			BaseX = stdInfo.BaseX;
			BaseY = stdInfo.BaseY;
		}
		/// <summary>
		...
		/// <param name="stdInfo">The HG3STDINFO struct containing image dimension information.</param>
		/// <param name="hg3">The HG-3 containing this image set.</param>
		internal Hg3OldImage(int imageIndex, HG3STDINFO stdInfo, Hg3Old hg3) {
			Hg3 = hg3;
			ImageIndex = imageIndex;
		...
		public override string ToString() => $"{Width}x{Height} Center={BaseX},{BaseY}";
