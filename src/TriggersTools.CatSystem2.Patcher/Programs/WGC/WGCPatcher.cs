...
namespace TriggersTools.CatSystem2.Patcher {
	public class WGCPatcher : ProgramPatcher {
		...
		internal const ushort SettingsName = 145;
		...
		internal static readonly string[] SettingsStrings = ReadStrings($"dialog_{SettingsName}.txt");
		...
		public WGCPatcher() {
			...
			Add(new WGCSettingsDialogPatch(SettingsName));
